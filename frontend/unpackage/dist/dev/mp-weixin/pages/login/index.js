...
/***/ 35:
/*!************************************************************************!*\
  !*** C:/myprojects2/frontend/main.js?{"page":"pages%2Flogin%2Findex"} ***!
  \************************************************************************/
...
/***/ 36:
/*!*****************************************************!*\
  !*** C:/myprojects2/frontend/pages/login/index.vue ***!
  \*****************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_4586967a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=4586967a&lang=scss&scoped=true& */ 48);
...
/***/ 37:
/*!************************************************************************************************!*\
  !*** C:/myprojects2/frontend/pages/login/index.vue?vue&type=template&id=4586967a&scoped=true& ***!
  \************************************************************************************************/
...
/***/ 39:
/*!******************************************************************************!*\
  !*** C:/myprojects2/frontend/pages/login/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 40:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/myprojects2/frontend/pages/login/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _require = __webpack_require__(/*! ../../api/user.js */ 44),
  login = _require.login,
  checkServerHealth = _require.checkServerHealth;
  ...
  methods: {
    ...
    onWxLogin: function onWxLogin() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var _this$savedProfile, _this$savedProfile2, nick, avatar;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                try {
                  _this.loading = true;
                  // 优先使用本地保存的资料
                  nick = ((_this$savedProfile = _this.savedProfile) === null || _this$savedProfile === void 0 ? void 0 : _this$savedProfile.nickName) || '';
                  avatar = ((_this$savedProfile2 = _this.savedProfile) === null || _this$savedProfile2 === void 0 ? void 0 : _this$savedProfile2.avatarUrl) || '';
                  _this.draftName = nick;
                  _this.draftAvatar = avatar;
                  _this.showAuthSheet = true;
                } catch (err) {
    ...
    confirmAndLogin: function confirmAndLogin() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var code, avatarUrl, payload, originalCodeBeforeLogin, loginStartTime, resp, loginElapsed, errorMsg;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                if (!(!_this2.draftName || !_this2.draftName.trim())) {
                  _context2.next = 5;
                  break;
                }
                uni.showToast({
              ...
              case 16:
                ...
                console.error('[login] 获取 code 失败:', _context2.t0);
              ...
              case 22:
                // 头像可以为空，但昵称必须有
                avatarUrl = _this2.draftAvatar && _this2.draftAvatar !== _this2.defaultAvatar ? _this2.draftAvatar : ''; // 确保数据格式正确，严格按照后端期望的格式
                payload = {
                  code: code.trim(),
                  // 确保 code 是字符串且去除空格
                  userInfo: {
                    nickName: _this2.draftName.trim() || '',
                    avatarUrl: avatarUrl || ''
                  }
                }; // 验证必要字段
              ...
              case 28:
                ...
                // 保存原始 code 用于后续对比
                originalCodeBeforeLogin = payload.code;
              ...
              case 41:
                resp = _context2.sent;
                loginElapsed = Date.now() - loginStartTime;
                console.log("[login] \u767B\u5F55\u8BF7\u6C42\u5B8C\u6210\uFF0C\u8017\u65F6: ".concat(loginElapsed, "ms"));
              ...
              case 47:
                ...
                break;
              case 54:
                throw new Error((resp === null || resp === void 0 ? void 0 : resp.message) || (resp === null || resp === void 0 ? void 0 : resp.msg) || '登录失败，服务器返回异常');
              case 55:
                _context2.next = 63;
                break;
              case 57:
                ...
                console.error('confirm login error', _context2.t1);
                errorMsg = '登录失败'; // 检查是否是 HTTP 状态码错误
                if (_context2.t1 && _context2.t1.statusCode) {
                  errorMsg = _context2.t1.message || "\u670D\u52A1\u5668\u9519\u8BEF (".concat(_context2.t1.statusCode, ")");
                  console.error("[login] HTTP\u9519\u8BEF\u72B6\u6001\u7801: ".concat(_context2.t1.statusCode), _context2.t1.responseData);
                } else if (_context2.t1 && _context2.t1.message) {
                  // 直接使用错误消息（已经包含了详细的诊断信息）
                  errorMsg = _context2.t1.message;
                } else if (_context2.t1 && _context2.t1.errMsg) {
                  if (_context2.t1.errMsg.includes('timeout')) {
                    errorMsg = '请求超时，请检查服务器是否正在运行';
                  } else {
                    errorMsg = "\u7F51\u7EDC\u9519\u8BEF: ".concat(_context2.t1.errMsg);
                  }
                }
...
/***/ 48:
/*!***************************************************************************************************************!*\
  !*** C:/myprojects2/frontend/pages/login/index.vue?vue&type=style&index=0&id=4586967a&lang=scss&scoped=true& ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
